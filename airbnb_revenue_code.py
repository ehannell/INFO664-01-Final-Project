...
#function for getting correct borough price
...
#Create function to call a map over New York City
...
#sight_seeing = f"C:/Users/erikh/Desktop/Pratt/Programming/finalproject/nycmuseums.geojson"
#base_map.add_child(folium.GeoJson(sight_seeing,
#                                  name='geojson'))
