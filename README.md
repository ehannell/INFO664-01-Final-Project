...
This Carto map is an interactive replica of the Lealet Folium-map that is generated from [final_project_code.py](https://github.com/ehannell/INFO664-01-Final-Project/blob/master/final_project_code.py). The Carto map is based on data from 12/2/2019.
